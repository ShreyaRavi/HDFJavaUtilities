...
public class BoolCharHashMapTest implements HDF5Serializable {
	
	public HashMap<Boolean, Character> test = new HashMap<Boolean, Character>();
	
	public BoolCharHashMapTest() {
		
	}
	
	public BoolCharHashMapTest(boolean keyX, char valX, boolean keyY, char valY, boolean keyZ, char valZ) {
		test.put(keyX, valX);
		test.put(keyY, valY);
		test.put(keyZ, valZ);
	}
