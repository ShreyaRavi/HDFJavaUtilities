...
public class BoolCharTreeMapTest implements HDF5Serializable {
	
	public TreeMap<Boolean, Character> test = new TreeMap<Boolean, Character>();
	
	public BoolCharTreeMapTest() {
		
	}
	
	public BoolCharTreeMapTest(boolean keyX, char valX, boolean keyY, char valY, boolean keyZ, char valZ) {
		test.put(keyX, valX);
		test.put(keyY, valY);
		test.put(keyZ, valZ);
	}
